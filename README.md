...
### OpenRefine 3.9.0+ support:
  - [Use Release 1.4.5](https://github.com/thadguidry/refine-groovy/releases/download/1.4.5/refine-groovy.zip)

# Install

1. Download the `.zip` file of the latest release using above link.
